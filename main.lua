...
local theme = {
    ...
    light_contrast = Color3.fromRGB(20, 0, 20),
    dark_contrast = Color3.fromRGB(10, 0, 10),
...
do
    ...
    window.cursor = {}
    --
    -- Cursor visuals removed
    --
    uis.MouseIconEnabled = true -- Re-enable default mouse cursor if needed
    --
